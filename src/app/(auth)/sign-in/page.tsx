        ...
        <form onSubmit={handleSignIn} className="space-y-6">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 bg-white text-gray-900 placeholder-gray-500"
              placeholder="build@adamur.io"
            />
          </div>
          <div>
            <label
